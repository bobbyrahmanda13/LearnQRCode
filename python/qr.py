...
def addLogo(qr_code, gambar):
    ...
    gambar = gambar.resize((80, 80))  # Ubah ukuran gambar sesuai kebutuhan
...
# Tautan Instagram
instagram_link = "instagram.com/rahman.rvbr"
# Tautan Telegram
...
qr_image = qr.make_image(
    ...
    color_mask=RadialGradiantColorMask(back_color=(255,255,255), edge_color=(0,200,0), center_color=(0,0,0))
)
